...
df = pd.read_sql_table('bulletins', con=engine, schema="public", index_col="id", columns=["CD_ELEICAO", "SG_UF", "NM_VOTAVEL", "NR_VOTAVEL", "QT_VOTOS"])
...
df2 = df.groupby(["CD_ELEICAO", "SG_UF", "NM_VOTAVEL", "NR_VOTAVEL"], as_index=False, dropna=False).agg(agg_dict)
