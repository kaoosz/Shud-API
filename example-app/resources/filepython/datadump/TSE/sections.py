...
url = "https://shud01.nyc3.digitaloceanspaces.com/eleicoes/localidades/BR_Zona_Secao_2018.csv"

#url = "https://shud01.nyc3.digitaloceanspaces.com/eleicoes/localidades/csv/BR_Zona_Secao_2018.csv"

def download_file(url, dest_path="/tmp/"):
    local_filename = url.split('/')[-1]
    final_file = dest_path+local_filename
...
# url = "https://shud.nyc3.digitaloceanspaces.com/eleicoes/localidades/BR_Zona_Secao_2020.csv"
...
sections = [
    {
        "year":"2018",
        "section_urls":[
            "https://shud01.nyc3.digitaloceanspaces.com/eleicoes/localidades/csv/BR_Zona_Secao_2018.csv",
...
for candidate in sections:
    ...
    for section_url in candidate["section_urls"]:
        ...
        for df in chunks:
            ...
            df.to_sql("sections_2018", con=engine, schema="public", if_exists="replace" if isFirst else "append", index='id')
